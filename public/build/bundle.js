...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-1vpuulx");
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-1laey66");
    			add_location(div, file$6, 18, 4, 483);
    			attr_dev(button, "class", "close svelte-1laey66");
    			add_location(button, file$6, 21, 4, 549);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$6, 22, 4, 628);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$5, 22, 0, 532);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h4 = element("h4");
    			h4.textContent = "Ratings Average: 0";
    			add_location(h4, file$4, 14, 4, 401);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h4 = element("h4");
    			t0 = text("Ratings Average: ");
    			t1 = text(/*average*/ ctx[1]);
    			add_location(h4, file$4, 12, 4, 339);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    			append_dev(h4, t0);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			if_block.c();
    			add_location(h4, file$4, 10, 4, 288);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$FeedbackStore, count*/ 5) {
    			$$invalidate(1, average = ($FeedbackStore.reduce((a, { rating }) => a + rating, 0) / count).toFixed(1));
    		}
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-56ntsf"));
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-56ntsf"))) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 15, 6, 308);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-ywbznt");
    			add_location(label0, file$2, 16, 6, 416);
    			attr_dev(li0, "class", "svelte-ywbznt");
    			add_location(li0, file$2, 14, 4, 296);
    			...
    			add_location(input1, file$2, 19, 6, 472);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-ywbznt");
    			add_location(label1, file$2, 20, 6, 580);
    			attr_dev(li1, "class", "svelte-ywbznt");
    			add_location(li1, file$2, 18, 4, 460);
    			...
    			add_location(input2, file$2, 23, 6, 636);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-ywbznt");
    			add_location(label2, file$2, 24, 6, 744);
    			attr_dev(li2, "class", "svelte-ywbznt");
    			add_location(li2, file$2, 22, 4, 624);
    			...
    			add_location(input3, file$2, 27, 6, 800);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-ywbznt");
    			add_location(label3, file$2, 28, 6, 908);
    			attr_dev(li3, "class", "svelte-ywbznt");
    			add_location(li3, file$2, 26, 4, 788);
    			...
    			add_location(input4, file$2, 31, 6, 964);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-ywbznt");
    			add_location(label4, file$2, 32, 6, 1072);
    			attr_dev(li4, "class", "svelte-ywbznt");
    			add_location(li4, file$2, 30, 4, 952);
    			...
    			add_location(input5, file$2, 35, 6, 1128);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-ywbznt");
    			add_location(label5, file$2, 36, 6, 1236);
    			attr_dev(li5, "class", "svelte-ywbznt");
    			add_location(li5, file$2, 34, 4, 1116);
    			...
    			add_location(input6, file$2, 39, 6, 1292);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-ywbznt");
    			add_location(label6, file$2, 40, 6, 1400);
    			attr_dev(li6, "class", "svelte-ywbznt");
    			add_location(li6, file$2, 38, 4, 1280);
    			...
    			add_location(input7, file$2, 43, 6, 1456);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-ywbznt");
    			add_location(label7, file$2, 44, 6, 1564);
    			attr_dev(li7, "class", "svelte-ywbznt");
    			add_location(li7, file$2, 42, 4, 1444);
    			...
    			add_location(input8, file$2, 47, 6, 1620);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-ywbznt");
    			add_location(label8, file$2, 48, 6, 1728);
    			attr_dev(li8, "class", "svelte-ywbznt");
    			add_location(li8, file$2, 46, 4, 1608);
    			...
    			add_location(input9, file$2, 51, 6, 1784);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-ywbznt");
    			add_location(label9, file$2, 52, 6, 1895);
    			attr_dev(li9, "class", "svelte-ywbznt");
    			add_location(li9, file$2, 50, 4, 1772);
    			attr_dev(ul, "class", "rating svelte-ywbznt");
    			add_location(ul, file$2, 13, 0, 271);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-1jeum61");
    			add_location(div, file$1, 59, 8, 1736);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1jeum61");
    			add_location(h2, file$1, 47, 8, 1243);
    			attr_dev(header, "class", "svelte-1jeum61");
    			add_location(header, file$1, 46, 4, 1225);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us something that keeps you coming back");
    			attr_dev(input, "class", "svelte-1jeum61");
    			add_location(input, file$1, 54, 12, 1486);
    			attr_dev(div, "class", "input-group svelte-1jeum61");
    			add_location(div, file$1, 53, 8, 1447);
    			add_location(form, file$1, 50, 4, 1315);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 47, 0, 1858);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
